...
def build_session_context(
  ...
  a LangGraph child agent inherits the correct depth without an ADK ToolContext.
  """
...
def _reject_unknown_tools(tools: list[str]) -> None:
  ...
  whichever runtime runs the config is never rejected. Imported lazily to keep
  this module's import graph independent of the ADK toolset.
  """
  from ..handa_adk.tools.registry import known_agent_tool_names
