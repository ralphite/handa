...
HISTORY_BOUNDARY_EVENT_KIND = "browser.history_boundary"
...
async def run(
  ...
  return await run_native_agent(
      ...
      event_prefix="browser",
      event_id_prefix="browser",
      call_id_prefix="browser_call",
      fallback_session_prefix="browser",
