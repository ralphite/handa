...
class AgentConfigNode:
  ...
  def __init__(
      ...
      *,
      ...
      suppress_task_notification: bool = True,
  ):
    ...
    self.suppress_task_notification = suppress_task_notification
  ...
  async def run(self, context: RalphLoopContext, prompt: str) -> NodeResult:
    ...
    task = start_agent_run_task(
        ...
        suppress_task_notification=self.suppress_task_notification,
    )
